			...
			if Elements.UIPageLayout.CurrentPage ~= TabPage then
				...
				shrinkTween.Completed:Connect(function()
					...
					morphTween.Completed:Connect(function()
						...
						-- 灵动岛样式：新页面放大淡入
						local expandTween = TweenService:Create(TabPage, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
						...
						-- 灵动岛样式：形变效果
						local newMorphTween = TweenService:Create(TabPage, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
						...
						expandTween.Completed:Connect(function()
							newMorphTween:Play()
							newMorphTween.Completed:Connect(function()
								finalTween:Play()
							end)
						end)
						
						-- 更新UIPageLayout的CurrentPage
