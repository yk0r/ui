	...
	function Window:CreateTab(Name, Image, Ext)
		...
		TabButton.Interact.MouseButton1Click:Connect(function()
			...
			if currentPage and currentPage ~= TabPage then
				TweenService:Create(currentPage, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			...
			if Elements.UIPageLayout.CurrentPage ~= TabPage then
				-- 先设置页面为初始状态（缩小且透明）
				TabPage.Size = UDim2.new(0.8, 0, 0.8, 0)
				...
				-- 对新页面应用放大淡入动画
				TweenService:Create(TabPage, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
